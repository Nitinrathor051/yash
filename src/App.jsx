    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Manu 💝</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Manu 💝's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Manu 💝, my heart is yours today and always 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">With All My Love — Manu 💝💖</h2>
          <p className="final-subtitle">"Manu 💝, on this special day, I just want you to know that you are my everything. Every smile, every laugh, every moment with you is pure magic. Happy Birthday, my love — forever yours,
— Yash 💖"</p>
        </section>
      </div>
