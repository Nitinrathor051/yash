...
function CelebrationPage({ onComplete, musicPlayerRef }) {
  ...
  // QNA Slides data - personalized for Manu 💝
  const slides = [
    {
      icon: "✨",
      text: "It's Your Special Day, Manu 💝!",
      type: "announcement",
    },
    {
      icon: "✨",
      text: "Do you want to see the surprise I made for you, my love?",
      type: "question",
      options: [
        { text: "Yes! 💖", value: "yes" },
        { text: "No 😢", value: "no" },
    ...
    {
      icon: "✨",
      text: "Here’s everything I prepared for you, Manu 💝!",
      type: "announcement",
    },
  ];
    ...
    setTimeout(() => {
      ...
      if (decoration) {
        if (buttonType === "decorate") {
          ...
          gsap.fromTo(decoration, { opacity: 0 }, { opacity: 1, duration: 1.2 });
          ...
          <div className="celebration-buttons">
            ...
            <div className="buttons-grid">
              ...
              {showMessageButton && (
                ...
                >
                  💌 I Have a Special Message for You, Manu 💝
                </button>
              )}
            </div>
          </div>
